...
#define  ledPin  A2 // onboard led 
#define  buttonPin  0 // push button

/* Example for Arduino MKR board +  MKR RS485 Shield
   DIP - Switch Setting of MKR Shield
...
void setup()
{
  ...
  */
  ...
  modbus_configure(9600, 1, true, TOTAL_REGS_SIZE, 0);
